...
namespace Editor.AssetsManager
{
    ...
    public static class NamingValidator
    {
        ...
        {
            // Unity 特有关键字
            "Material", "Shader", "Texture", "GameObject", "Transform",
            "RectTransform", "Canvas", "Rigidbody", "Collider", "MonoBehaviour",
            "ScriptableObject", "Prefab", "AssetBundle", "EditorWindow",
            
            // 原有 C# 关键字
            "typeof", "uint", "ulong", "unsafe",
            "unchecked",
            "unsafe",
            "ushort",
            "using",
